export const RecentProjectData = [
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + '/images/whatsapp-clone-thumbnail.png',
    buttons: [ { label: 'Code', link: 'https://github.com/Shakl0ne/whatsapp-clone' },],
  },
  {
    title: 'neuron',
    detail:
      'An data synchronization Java Quarkus project using with Kafka and Debezium.',
    image: process.env.PUBLIC_URL + '/images/neuron-thumbnail.png',
